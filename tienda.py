...
import data  # Importar el módulo completo para poder modificar saldo_user
...
def mostrar_tienda():
    ...
    ╚══════════════════════════════════════════════════════╝
    """)
    print(f"Tu saldo actual es de: {Fore.LIGHTYELLOW_EX}{data.saldo_user} G")
...
def compra_animales():
    ...
    match opcion:
        case 1 | 2 | 3 | 4 | 5:
            ...
            if data.saldo_user >= total:
                data.saldo_user -= total
        ...
        case 6:
            ...
            print("Que animal deseas vender?")
            ...
            data.saldo_user += total_venta
            restart()
            print(f"Vendiste {cantidad_v} {Fore.LIGHTCYAN_EX}{animal_elegido}(s){Fore.RESET} por {Fore.YELLOW}{total_venta} G.")
            print(f"Nuevo saldo: {Fore.YELLOW}{data.saldo_user} G")
            mostrar_tienda()
            compra_animales()
